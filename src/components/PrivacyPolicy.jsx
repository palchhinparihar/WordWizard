      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12 animate-fadeIn">
          ...
          <p className="text-lg text-gray-300 max-w-2xl mx-auto">
            Your privacy is important to us. This Privacy Policy explains how we collect, use, and protect your personal information when you use <span className="font-semibold text-white">WordWizard</span>.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-300 text-sm">Request a copy of your personal information at any time.</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <CheckCircle className="w-5 h-5 text-green-400 mt-1 flex-shrink-0" />
              <div>
                ...
                <p className="text-gray-300 text-sm">Request deletion of your data from our systems.</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <CheckCircle className="w-5 h-5 text-green-400 mt-1 flex-shrink-0" />
              <div>
                <h3 className="font-semibold text-white mb-1">No Third-Party Sharing</h3>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-300 text-sm">Clear communication about how we handle your information.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-white font-semibold">{new Date().toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}</p>
            </div>
          </div>
          <a 
